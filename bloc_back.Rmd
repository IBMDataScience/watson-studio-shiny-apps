...
p2 <- figure() %>%
  ly_points(heating_gas*100, plug_load_consumption*100, data = df,fill_color =color,fill_alpha = 0.6, hover = c(property_name,Annual.Energy.Bill..USD. ),legend_location = "top_right", xlab='Heating Gas', ylab = 'Plug Load Consumption') %>% 
